  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-lg relative">
        ...
        <h2 className="text-3xl font-bold text-niyantran-deep-blue mb-2 text-center">Give us 2 Weeks.<br /><span className="text-niyantran-orange">We will give you a Disciplined Child.</span></h2>
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input type="text" name="parentName" value={formData.parentName} onChange={handleChange} required className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-niyantran-orange focus:outline-none" placeholder="Enter your full name" />
            </div>
            <div>
              ...
              <select name="childClass" value={formData.childClass} onChange={handleChange} required className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-niyantran-orange focus:outline-none">
            ...
            <div>
              ...
              <input type="tel" name="whatsappNumber" value={formData.whatsappNumber} onChange={handleChange} required pattern="[0-9]{10}" className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-niyantran-orange focus:outline-none" placeholder="10-digit mobile number" />
            ...
            <button type="submit" disabled={isSubmitting} className="w-full bg-niyantran-orange hover:bg-niyantran-gold text-white font-bold py-3 px-8 rounded-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
              {isSubmitting ? 'Submitting...' : (<><span>Book Free Consultation</span><Send className="w-5 h-5" /></>)}
            </button>
